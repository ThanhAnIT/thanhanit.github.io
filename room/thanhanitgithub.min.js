...
"use strict";var config=require("./config");config.SockJS&&(config.SockJS=require("sockjs-client")),config.WS&&(config.WS=require("ws"));var Promise=require("lie"),Events=require("backbone-events-standalone"),Room=require("./room.js"),assign=require("lodash.assign"),get=require("lodash.get"),omit=require("lodash.omit"),sockEvents=require("./sock_events.js"),_require=require("./utils"),isString=_require.isString,isFunction=_require.isFunction,wrapError=_require.wrapError,hasListeners=_require.hasListeners,warn=_require.warn,States={CLOSED:0,OPEN:1,HANDSHAKEN:2,AUTHENTICATED:3},ABNORMAL_CLOSURE=1006,isNode=config.isNode,isBrowser=config.isBrowser,isBrowserLite=config.isBrowserLite,isReactNative=config.isReactNative,reconnectAttempt=0;function Scaledrone1(e,t){var r=this;if(!e)throw new Error("No Channel ID is defined");if(!isString(e))throw new Error("Channel ID must be of type string");t=assign({},{autoReconnect:!0,url:null,originalInstance:this,data:null,debug:!1},t),this.args=arguments,this.args[1]=t,this.originalInstance=t.originalInstance,this.readyState=States.CLOSED,this.callbackId=0,this.callbacks={},this.rooms={},this.disconnected=!1,this.connection=getConnection(t),this.emitter=Events.mixin({}),sockEvents(this.connection,this.emitter,{debug:t.debug}),this.autoReconnect=t.autoReconnect,this.innerEmitter=Events.mixin({}),this.eventPromises=this.createEventPromises(),this.emitter.on("open",function(){r.readyState=States.OPEN,r._sendMessage("handshake",{channel:e,version:2,client_data:t.data},{},function(e,t){e||(r.clientId=t.client_id,r.readyState=States.HANDSHAKEN,r.requireAuth=t.require_auth),r._trigger("open",e)})}),this.emitter.on("message",function(e){var t=JSON.parse(e.data),n=omit(t,["callback","error"]);if(-1===["observable_members","observable_member_join","observable_member_leave"].indexOf(t.type)){if(null!=t.callback){var i=t.callback,o=r.callbacks[i];if(isFunction(o))return o(wrapError(t.error),n),void delete r.callbacks[i]}if(t.error)r.trigger("error",wrapError(t.error));else{if("publish"===t.type){var s=r.rooms[t.room];if(!s)return;var c={data:t.message,id:t.id,timestamp:t.timestamp},a=t.client_id;t.client_id&&(c.clientId=a);var u=void 0;return s._observable&&a&&(u=s._getCacheMember(a),c.member=u),s.trigger("message",c),void s.trigger("data",t.message,u)}if("history_message"!==t.type);else{var l=r.rooms[t.room];if(!l)return;l._handleHistoryMessage(t)}}}else{var g=r.rooms[t.room];if(!g)return;var d=t.type.slice("observable_".length);g.trigger(d,t.data)}}),this.emitter.on("close",function(e){r.autoReconnect&&get(e,"code")===ABNORMAL_CLOSURE&&-1===get(e,"reason","").indexOf("exceeded")?(r.disconnected||r.trigger("disconnect"),reconnect(r,t,e)):r.trigger("close",e)}),this.emitter.on("error",function(e){return r.trigger("error",e)}),this.emitter.on("disconnect",function(){return r.disconnected=!0}),this.emitter.on("reconnect",function(){return r.disconnected=!1}),this.emitter.on("authenticate",function(e){return r._trigger("authenticate",e)})}function reconnect(e,t,r){var n=e.originalInstance;if(reconnectAttempt>25)n.trigger("close",r);else{var i=1e3*reconnectAttempt++*(Math.random()+.5);setTimeout(function(){var t=n.args,r=new Scaledrone1(t[0],t[1]);r.innerEmitter.on("open",function(){for(var t in reconnectAttempt=0,r.emitter=n.emitter,e.connection.old=!0,n.connection=r.connection,sockEvents(r.connection,n.emitter),n.rooms)r.subscribe(t);n.trigger("reconnect")})},i)}}function getConnection(e){return"sockjs"!==e.type&&supportsWebsockets()?isNode?new config.WS(e.url||config.websocketUrl,config.websocketOptions):new WebSocket(e.url||config.websocketUrl):new config.SockJS(e.url||config.sockjsUrl,null,{transports:["xdr","websocket-streaming","xhr-streaming","iframe-eventsource","iframe-htmlfile","xdr-polling","xhr-polling","iframe-xhr-polling","jsonp-polling"]})}function supportsWebsockets(){return!!isBrowserLite||(!(!isNode||"sockjs"===config.type)||(!!(isBrowser&&"WebSocket"in window&&2===window.WebSocket.CLOSING)||!!isReactNative))}Events.mixin(Scaledrone1.prototype),Scaledrone1.prototype._trigger=function(e,t){hasListeners(this,e)?this.trigger(e,t):t&&this.trigger("error",t),this.innerEmitter.trigger(e,t)},Scaledrone1.prototype._sendMessage=function(e,t){var r=this,n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{},i=arguments[3],o=assign({type:e},t);if(i){var s=this.callbackId++;o.callback=s,this.callbacks[s]=i}(n.waitForPromise||Promise.resolve()).then(function(){return r.connection.send(JSON.stringify(o))})},Scaledrone1.prototype.subscribe=function(e){var t=(arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}).historyCount;if(!e)throw new Error("Room name is not defined");if(!isString(e))throw new Error("Room name must be of type string");var r=new Room(e,{historyCount:t},this);return this.rooms[e]=r,this._sendMessage("subscribe",{room:e,history:t,history_count:t},{waitForPromise:this.eventPromises.fullyConnected},function(e){return r._trigger("open",e)}),r},Scaledrone1.prototype.unsubscribe=function(e){if(!e)throw new Error("Room name is not defined");if(!isString(e))throw new Error("Room name must be of type string");this._sendMessage("unsubscribe",{room:e},{waitForPromise:this.eventPromises.fullyConnected})},Scaledrone1.prototype.publish=function(e){if(!e)throw new Error("No options defined");if(!e.room)throw new Error("No room defined");if(!e.message)throw new Error("No message defined");if(this.readyState===States.CLOSED)throw new Error("Connection is closed");var t={waitForPromise:this.eventPromises.fullyConnected};this.requireAuth&&this.readyState!==States.AUTHENTICATED&&(warn("Messages can be sent after authenticating"),t={}),this._sendMessage("publish",{room:e.room,message:e.message},t)},Scaledrone1.prototype.authenticate=function(e){var t=this;if(!e)throw new Error("No token defined");this._sendMessage("authenticate",{token:e},{waitForPromise:this.eventPromises.open},function(r){t.readyState=States.AUTHENTICATED,t.token=e,t.emitter.trigger("authenticate",r)})},Scaledrone1.prototype.close=function(){this.connection.close()},Scaledrone1.prototype.createEventPromises=function(){var e=this;return{fullyConnected:new Promise(function(t,r){e.innerEmitter.once("open",function(n){n?r(n):e.requireAuth?e.innerEmitter.once("authenticate",function(e){e?r(e):t()}):t()})}),open:new Promise(function(t,r){e.innerEmitter.once("open",function(e){e?r(e):t()})})}},isBrowser?window.Scaledrone1=window.Scaledrone1=Scaledrone1:module.exports=Scaledrone1;
...
"use strict";var Events=require("backbone-events-standalone"),_require=require("./utils"),hasListeners=_require.hasListeners;function Room(e,t,s){var i=this,r=t.historyCount;this.name=e,this._history={messages:[],nextIndex:0},this._historyCount=r,this._historyReceivedCount=0,this.Scaledrone1=s,this._observable=isObservable(e),this._observable&&(this._cache=[],this.on("members",function(e){return i._cache=e.slice(0)}),this.on("member_join",function(e){return i._cache.unshift(e)}))}function isObservable(e){return e&&"observable-"===e.substring(0,11)}Events.mixin(Room.prototype),Room.prototype.unsubscribe=function(){this.off(),this.Scaledrone1.unsubscribe(this.name)},Room.prototype._getCacheMember=function(e){if("string"!=typeof e)return null;for(var t=0;t<this._cache.length;t++){var s=this._cache[t];if(s.id===e)return s}return null},Room.prototype._trigger=function(e,t){hasListeners(this,e)?this.trigger(e,t):t&&this.Scaledrone1.trigger("error",t)},Room.prototype._handleHistoryMessage=function(e){var t=this;this._history.messages[e.index]=e,this._history.messages[this._history.nextIndex]&&function e(){var s=t._history.messages[t._history.nextIndex];t._history.nextIndex++;var i=s.message,r=s.client_id,n={data:i,timestamp:s.timestamp,id:s.id};r&&(n.clientId=r),t.trigger("history_message",n),t._history.messages[t._history.nextIndex]&&e()}()},module.exports=Room;

},{"./utils":74,"backbone-events-standalone":2}],73:[function(require,module,exports){
"use strict";module.exports=function(o,e){var n=(arguments.length>2&&void 0!==arguments[2]?arguments[2]:{}).debug;o.onopen=function(r){o.old||(n&&console.log("[Scaledrone1 DEBUGGER]: open",r),e.trigger("open",r))},o.onmessage=function(r){o.old||(n&&console.log("[Scaledrone1 DEBUGGER]: message",r),e.trigger("message",r))},o.onclose=function(r){o.old||(n&&console.log("[Scaledrone1 DEBUGGER]: close",r),e.trigger("close",r))},o.onerror=function(r){o.old||(n&&console.log("[Scaledrone1 DEBUGGER]: error",r),e.trigger("error",r))}};
